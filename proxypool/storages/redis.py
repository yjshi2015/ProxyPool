...
class RedisClient(object):
    ...
    def exits(self, proxy: Proxy) -> bool:
        """
           if proxy exists
           :param proxy: proxy
    ...
    def max(self, proxy: Proxy) -> int:
        ...
        if IS_REDIS_VERSION_2:
            self.db.zadd(REDIS_KEY, PROXY_SCORE_MAX, proxy.string())
        self.db.zadd(REDIS_KEY, {proxy.string(): PROXY_SCORE_MAX})
